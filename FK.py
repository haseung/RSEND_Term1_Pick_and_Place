...
T2_3 = Matrix([[             cos(q3),            -sin(q3),            0,              a2],
               [ sin(q3)*cos(alpha2), cos(q3)*cos(alpha2), -sin(alpha2), -sin(alpha0)*d3],
               [ sin(q3)*sin(alpha2), cos(q3)*sin(alpha2),  cos(alpha2),  cos(alpha0)*d3],
               [                   0,                   0,            0,               1]])
T2_3 = T2_3.subs(s)
T3_4 = Matrix([[             cos(q4),            -sin(q4),            0,              a3],
               [ sin(q4)*cos(alpha3), cos(q4)*cos(alpha3), -sin(alpha3), -sin(alpha0)*d4],
               [ sin(q4)*sin(alpha3), cos(q4)*sin(alpha3),  cos(alpha3),  cos(alpha0)*d4],
               [                   0,                   0,            0,               1]])
T3_4 = T3_4.subs(s)
T4_5 = Matrix([[             cos(q5),            -sin(q5),            0,              a4],
               [ sin(q5)*cos(alpha4), cos(q5)*cos(alpha4), -sin(alpha4), -sin(alpha0)*d5],
               [ sin(q5)*sin(alpha4), cos(q5)*sin(alpha4),  cos(alpha4),  cos(alpha0)*d5],
               [                   0,                   0,            0,               1]])
T4_5 = T4_5.subs(s)
T5_6 = Matrix([[             cos(q6),            -sin(q6),            0,              a5],
               [ sin(q6)*cos(alpha5), cos(q6)*cos(alpha5), -sin(alpha5), -sin(alpha0)*d6],
               [ sin(q6)*sin(alpha5), cos(q6)*sin(alpha5),  cos(alpha5),  cos(alpha0)*d6],
               [                   0,                   0,            0,               1]])
T5_6 = T5_6.subs(s)
...
#IK to solve for joint variables q1, q2, q3

#Euler angles corresponding to the rotation matrix
R0_3 = T0_3[0:3, 0:3]
R3_6 = np.transpose(R0_3) * R0_6

#IK to solve for joint variables q4, q5, q6
